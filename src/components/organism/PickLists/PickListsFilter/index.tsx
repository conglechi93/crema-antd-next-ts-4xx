...
import usePickListsFilter from './usePickListsFilter';
import AppSelectAll from 'components/atoms/AppSelectAll';
type PickListsFilterProps = {
  handleChangeSearchParams: (params: any, resetRecord?: boolean) => void;
};
const PickListsFilter = (props: PickListsFilterProps) => {
  ...
  const {
    ...
    statusOptions,
  } = usePickListsFilter(handleChangeSearchParams);
              ...
              <AppForm form={form}>
                ...
                >
                  <AppSearch
                    ...
                    placeholder={
                      messages['common.pickListSearchHint'] as string
                    }
...
export default PickListsFilter;
